...
use ir::{
    BlockId, FuncType, Function, FunctionBody, ImportedFunction, Instruction, InstructionArith,
...
impl Thread {
    ...
    pub fn symbolic_registers(&self) -> &BitSet {
        &self.symbolic_registers
    }

    pub fn symbolic_registers_mut(&mut self) -> &mut BitSet {
